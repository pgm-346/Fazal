                            ...
                            <label for="term" class="col-md-4 col-form-label text-md-right">Term</label>
                                <select name="term" id="term" required autofocus>
                                    ...
                                    <?php if($errors->has('term')): ?>
                                        <span class="text-danger"><?php echo e($errors->first('term')); ?></span>
                                    <?php endif; ?>
                                </select>
                        </div>
                        <div class="form-group row">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/login-mechine-test/resources/views/dashboard.blade.php ENDPATH**/ ?>