              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form action="<?php echo e(route('register.post')); ?>" method="POST">
                          ...
                          <input type="hidden" value="0" name="account_balance">
                          <div class="form-group row">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/allianze/Documents/bank/resources/views/auth/registration.blade.php ENDPATH**/ ?>