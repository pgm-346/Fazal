    ...
    <div class="container box">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-4" align="left">Account Holder - <b><span><?php echo e(Auth::user()->name); ?></span></b></div>
                    ...
                    <div class="col-md-3" align="right">
                        ...
                        <a href="<?php echo e(url('dashboard')); ?>" class="btn btn-success btn-sm">Back</a>
                    </div>
                </div>
            </div>
...
$(document).ready(function(){
 ...
 function fetch_data(from_date, to_date)
 {
    ...
    $.ajax({
        url:"<?php echo e(route('daterange.fetch_data')); ?>",
    method:"POST",
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/allianze/Documents/bank/resources/views/statement.blade.php ENDPATH**/ ?>